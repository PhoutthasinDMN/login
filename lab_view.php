...
if (!isset($_GET['id']) || empty($_GET['id'])) {
  echo "<script>" . "window.location.href='./lab_results.php';" . "</script>";
  exit;
}
  ...
  <div class="flex">
    ...
    <main class="ml-64 flex-1 p-8">
      <div class="mb-6 flex justify-between items-center">
        <div>
          ...
          <p class="text-gray-600">
            ผู้ป่วย: <strong><?= htmlspecialchars($lab_result['patient_name']); ?></strong> 
            (HN: <?= htmlspecialchars($lab_result['hn']); ?>)
          </p>
        </div>
          ...
          <div class="p-4">
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p class="font-semibold"><?= htmlspecialchars($lab_result['lab_type']); ?></p>
              </div>
              <?php if (!empty($lab_result['lab_details'])) : ?>
              <div class="col-span-2">
                <p class="text-sm text-gray-500">รายละเอียด</p>
                <p class="font-semibold"><?= htmlspecialchars($lab_result['lab_details']); ?></p>
              </div>
              <?php endif; ?>
            </div>
          </div>
          ...
          <div class="p-4">
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p class="font-semibold"><?= htmlspecialchars($lab_result['blood_pressure']); ?> มม.ปรอท</p>
              </div>
              <?php endif; ?>
              ...
              <div>
                ...
                <p class="font-semibold"><?= htmlspecialchars($lab_result['pulse']); ?> ครั้ง/นาที</p>
              </div>
              <?php endif; ?>
              ...
              <div>
                ...
                <p class="font-semibold"><?= htmlspecialchars($lab_result['temperature']); ?> °C</p>
              </div>
              <?php endif; ?>
            </div>
          </div>
          ...
          <div class="p-4">
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p class="font-semibold"><?= htmlspecialchars($lab_result['weight']); ?> กก.</p>
              </div>
              <?php endif; ?>
              ...
              <div>
                ...
                <p class="font-semibold"><?= htmlspecialchars($lab_result['height']); ?> ซม.</p>
              </div>
              <?php endif; ?>
              ...
              <div>
                ...
                <p class="font-semibold"><?= htmlspecialchars($lab_result['bmi']); ?></p>
              </div>
              <?php endif; ?>
            </div>
          </div>
          ...
          <div class="p-4">
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p class="font-semibold"><?= htmlspecialchars($lab_result['glucose']); ?> มก./ดล.</p>
              </div>
              <?php endif; ?>
              ...
              <div>
                ...
                <p class="font-semibold"><?= htmlspecialchars($lab_result['cholesterol']); ?> มก./ดล.</p>
              </div>
              <?php endif; ?>
            </div>
          </div>
      ...
      <?php foreach ($lab_categories as $category) : ?>
        <?php 
          $category_id = $category['id'];
          $category_items = $lab_details[$category_id] ?? [];
        ?>
        <?php if (!empty($category_items)) : ?>
        <div class="bg-white rounded-lg shadow-md mb-6">
          <div class="p-4 bg-yellow-500 text-white rounded-t-lg">
            <h2 class="text-lg font-semibold"><?= htmlspecialchars($category['category_name']); ?></h2>
          </div>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <span class="text-sm font-medium text-gray-900"><?= htmlspecialchars($item['item_name']); ?></span>
                  </td>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <?= htmlspecialchars($item['normal_range']); ?>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
      ...
      <div class="bg-white rounded-lg shadow-md mb-6">
        ...
        <div class="p-4">
          <p class="text-gray-800"><?= nl2br(htmlspecialchars($lab_result['note'])); ?></p>
        </div>
      </div>
      <?php endif; ?>
    </main>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#printLabBtn').click(function() {
        const patientName = "<?= htmlspecialchars($lab_result['patient_name']); ?>";
        const hn = "<?= htmlspecialchars($lab_result['hn']); ?>";
        const labDate = "<?= date('d/m/Y', strtotime($lab_result['lab_date'])); ?>";
        const labType = "<?= htmlspecialchars($lab_result['lab_type']); ?>";
